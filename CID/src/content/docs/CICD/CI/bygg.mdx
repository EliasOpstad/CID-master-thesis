...
![CI/CD Pipeline](../../../../assets/images/Bygg.png)

Når kodenendringen blir pushet til Github (versjonskontrollserver), utløses CI/CD pipelinen automatisk. Pipelinen starter med byggfasen. I denne fasen bygges prosjektet fra kildekode til et kjørbart format. Dette inkluderer følgende trinn:

1. **Kompilering av kode**: Koden oversettes fra kildekode (som Java, C++, Python) til maskinlesbar kode.
2. **Innsamling av avhengigheter**
...
Jenkins er et verktøy som automatiserer hele CI/CD prosessen. Verktøyet integreres med versjonskontrollserver for å bygge, teste og utplassere koden automatisk hver gang endringer pushes. Jenkins har et bredt spekter av plugins for å tilpasse pipelinene til utviklerens behov.
...
![Build With Jenkins and Docker](../../../../assets/images/BuildWithJenkinsAndDocker.png)
