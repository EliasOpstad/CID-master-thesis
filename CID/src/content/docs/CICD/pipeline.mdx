...
En CI/CD-pipeline er en serie automatiserte trinn som forbedrer hvordan små endringer integreres i større prosjekter. Dette sikrer at endringene kan dyttes og testes uten å krasje andre deler av applikasjonen. Her er de forskjellige fasene:

![CI/CD Pipeline](../../../assets/images/Pipeline.png)
