...
![CI/CD-pipeline](../../../../assets/images/StagingServer.png)

Når koden er bygget og testet, er det neste steget å utplassere den til en staging server. Jenkins kan hjelpe deg med å automatisere utplasseringsprosessen, slik at du raskt og effektivt kan teste koden din i et realistisk miljø før den rulles ut til produksjon. Dette sikrer at alt fungerer som forventet før koden når sluttbrukeren.
