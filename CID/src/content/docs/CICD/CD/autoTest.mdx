...
Jenkins har innebygde funksjoner for å automatisere testingen i en CI/CD-pipeline. Dette kan inkludere testtypene nevnt i **Fase 2: Test**. Implementasjon av automatiserte tester gir følgende fordeler:
