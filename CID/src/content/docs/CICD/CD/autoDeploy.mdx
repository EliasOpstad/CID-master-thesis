...
### Fordeler og scenarioer

##### **Kontinuerlig distribusjon (Continuous Delivery)**:

- **Ekstra sikkerhet**: Selve utrullingen til produksjon krever en **_manuell_** godkjenning.
- **Regulerte industrier**: Situasjoner hvor hver utrulling skal gjennomgå manuelt for ekstra sikkerhet.
